...
namespace Residue.Gameplay.World
{
    ...
    public sealed class LabRecords
    {
        ...
        /// <summary>
        /// True when this process holds the lab. The end-of-day report is drawn from
        /// <see cref="LabState.LastReports"/> and nothing carries a <c>ConsequenceReport</c> over the
        /// wire, so a client says where the summary is rather than showing an empty one.
        /// </summary>
        public bool IsLive;
